---
title: "Random Forest Starter Code"
format: docx
editor: visual
---

We're going to start out by letting you write code for Feature Engineering! Follow the steps outlined below. I'll show a solution for each step as we go.
...
Create a workflow that combines the recipe and model and fit it to the training data.
